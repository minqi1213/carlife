...
pm.checker = {
    initializeUrlChecker:function () {
        var checkerId;
        checkerId = "#checker-keyvaleditor";

        var params = {
            placeHolderKey:"Expect Key of URL Response Json",
            placeHolderValue:"Expect Value of URL Response Json",
            deleteButton:'<img class="deleteButton" src="img/delete.png">',
            onDeleteRow:function () {
                pm.request.setUrlParamString(pm.checker.getUrlEditorParams());
            },
        ...
        $(checkerId).keyvalueeditor('init', params);
